package wangwang.zxing.Scanning;
...
import wangwang.activity.WebActivity;

/**
 * 扫描二维码
 *com.zhangyx.TwoDimensionalCode.util.ZXing.Scanning.CaptureActivity
 * @author Admin-zhangyx
 *
 * create at 2014-12-22 下午4:18:05
 */
...
//					finish();
				...
				}else if(code.startsWith("tox:")){
					Intent intent = new Intent(CaptureActivity.this, AddActivity.class);
	...
	private void showCustomMessageOK(String pTitle, final String pMsg) {
		final Dialog lDialog = new Dialog(CaptureActivity.this,
