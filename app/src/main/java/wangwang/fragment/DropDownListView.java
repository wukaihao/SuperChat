...
public class DropDownListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerReleaseMinDistance = context.getResources().getDimensionPixelSize(
                cn.trinea.android.common.R.dimen.drop_down_list_header_release_min_distance);
    ...
    private void initOnBottomStyle() {
        ...
        footerDefaultText = context.getString(cn.trinea.android.common.R.string.drop_down_list_footer_default_text);
        footerLoadingText = context.getString(cn.trinea.android.common.R.string.drop_down_list_footer_loading_text);
        footerNoMoreText = context.getString(cn.trinea.android.common.R.string.drop_down_list_footer_no_more_text);
